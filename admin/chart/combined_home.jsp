...
<body>
    ...
    <div class="form-container">
        ...
        <div class="form-box">
            <h3>Select Year for Category Counts</h3>
            <form id="categoryYearForm">
                <label for="categoryYear">Select Year:</label>
                <select id="categoryYear" name="year">
                    <c:forEach var="y" items="${years}">
                        <option value="${y}">${y}</option>
                    </c:forEach>
                </select>
                <button type="submit">View Category Count Chart</button>
            </form>
        </div>
    </div>
